       ...
       <div class="auth__form">
        ...
        <div class="modal__footer">
          ...
          <label for="avt" id="avt">
            <img src="/lab1/assets/img/${typeImg}" alt="" class="imgmd" srcset="">
			...
			if (valueinputform2) {
				for (let i = 0; i < valueinputform2.length; i++) {
					if (
						...
						let htmlcmts = `
            <img src="/lab1/assets/img/${valueinputform2[i].img}"/>
            <span>
          ...
          `;
			...
			input2.addEventListener("keydown", (e) => {
				if (e.keyCode === 13 && input2.value !== "") {
					...
					let htmlcmt = `
          <img src="/lab1/assets/img/${typeImg}"/>
          <span>
          ${valuecmt}
          </span>
          <i class="fa-regular fa-rectangle-xmark closecmt"></i>
